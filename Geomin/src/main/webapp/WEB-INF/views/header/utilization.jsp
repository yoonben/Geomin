...
<div id='container'>
	...
	<div id='section'>
		...
		<div class="index">
			<p class="frist_p">이용약관은 다음과 같은 내용을 담고 있습니다.</p>
		</div>
	...
	<!-- 이용약관 끝 -->  
        ...
        <div id="introduction2" style="font-family: 'NanumSquareNeo-Variable';">
            ...
            <div id="a1" class="section">
            	...
            	<p><strong id="a1_1" class="b">네이버는 본 개인정보처리방침은 개인정보보호법을 기준으로 작성하되, 네이버 내에서의 이용자 개인정보 처리 현황을 최대한 알기 쉽고 상세하게 설명하기 위해 노력하였습니다.</strong><br />이는 쉬운 용어를 사용한 개인정보처리방침 작성 원칙인 &lsquo;Plain Language Privacy Policy(쉬운 용어를 사용한 개인정보처리방침)&rsquo;를 도입한 것입니다.</p>
       		</div>
	        ...
	        <div id="a3" class="section">
	            ...
	            <ul class="sec">
	                <li class="first last">
	                    <p><strong id="a3_1">네이버 및 네이버 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발&middot;제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.</strong></p>
	                </li>
	            </ul>
	        </div>
	        <div id="a4" class="section">
           	 ...
           	 <ul class="sec">
                <li class="first">
                    <p><strong id="a4_1">네이버는 원칙적으로 이용자 동의 없이 개인정보를 외부에 제공하지 않습니다.</strong></p>
                    <p>네이버는 이용자의 사전 동의 없이 개인정보를 외부에 제공하지 않습니다. 단, 이용자가 외부 제휴사의 서비스를 이용하기 위하여 개인정보 제공에 직접 동의를 한 경우, 그리고 관련 법령에 의거해 네이버에 개인정보 제출 의무가 발생한 경우, 이용자의 생명이나 안전에 급박한 위험이 확인되어 이를 해소하기 위한 경우에 한하여 개인정보를 제공하고 있습니다.</p>
             	</li></ul>
             	</div>
